...
add constraint game_draft_identity_matches check (
  ...
  and game->>'mechanic' in ('tap_or_wait', 'classify_and_sort', 'sequence_and_place')
);
...
begin
  ...
  if candidate_game->>'mechanic' not in ('tap_or_wait', 'classify_and_sort', 'sequence_and_place') then
