...
add constraint game_draft_identity_matches check (
  ...
  and game->>'mechanic' in ('tap_or_wait', 'classify_and_sort', 'sequence_and_place', 'emotion_clues', 'fish_patterns')
);
...
begin
  ...
  if candidate_game->>'mechanic' not in ('tap_or_wait', 'classify_and_sort', 'sequence_and_place', 'emotion_clues', 'fish_patterns') then
